...
|---|------|----|---------|------------|------|
| 1 | 공공도서관 + 도서 검색 | `library` | 교육/문화 | 정보나루(data4library.kr) — data.go.kr 통합 | ⏳ 진행 중 |
| 2 | 관광/전시·공연 | `tour` | 생활/문화 | 한국관광공사 TourAPI (data.go.kr) | ⏸ 대기 |
| 3 | 로또 | `lotto` | 생활 | 동행복권 회차 API | ⏸ 대기 |
| 4 | 농수산물 시세 | `price` | 생활/물가 | 농산물유통정보 KAMIS (data.go.kr) | ⏸ 대기 |
