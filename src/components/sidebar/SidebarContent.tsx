  ...
  return (
    <div className="flex h-full flex-col">
      <Link
        ...
        className="group flex h-14 items-center justify-center gap-2 px-3 transition md:justify-start md:px-5"
      >
        ...
        <span className="hidden text-sm font-semibold tracking-tight text-zinc-100 md:inline">
          DataWeave
        </span>
      </Link>

      <div aria-hidden className="mx-3 h-px bg-white/[0.08] md:mx-4" />

      <nav className="flex flex-1 flex-col px-2 py-4 md:px-3">
        ...
        return (
          <li key={it.href}>
            <Link
              ...
              title={it.label}
              className={`group relative flex items-center justify-center gap-3 rounded-lg px-2 py-2.5 text-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 md:justify-start md:px-3 ${
                active
