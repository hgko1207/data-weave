// 시·도 → 시·군·구 리스트. 행정안전부 행정구역 기준 (2024 군위군 대구 편입 반영).
// 세종특별자치시는 자치시라 시·군·구 없음 (빈 배열).
export const SIGUNGUS_BY_SIDO: Record<string, string[]> = {
  "서울특별시": [
